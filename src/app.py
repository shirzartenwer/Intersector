...
size_a = st.number_input("Size of "+name_of_two_collections[0]+":", min_value=0, max_value=1000000, value=50)
size_b = st.number_input("Size of "+name_of_two_collections[1]+":", min_value=0, max_value=1000000, value=25)
